...
<?php include(TEMPLATE_FRONT . DS . "header.php");  ?>
	...
	<div class="w3-top">
		<div class="w3-bar w3-red w3-card w3-left-align w3-large">
			...
			<a href="contact.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">Contact</a>
		</div>
			...
			<div class="row content_bottom-text">
			  <div class="col-md-7">
				...
				<p id="p" style="color:red;">
					If you would like to contact Jim about anything, please feel free to!
				</p>
